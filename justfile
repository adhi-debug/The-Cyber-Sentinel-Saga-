# =============================================================================
# adhi-debug | 2026
# Justfile - adhidebug AI Threat Detection
# =============================================================================
...
[group('adhidebug')]
adhidebug-config:
    cd backend && uv run adhidebug config
...
[group('adhidebug')]
adhidebug-train *ARGS:
    cd backend && uv run adhidebug train {{ARGS}}

[group('adhidebug')]
adhidebug-replay *ARGS:
    cd backend && uv run adhidebug replay {{ARGS}}

[group('adhidebug')]
adhidebug-download-csic:
