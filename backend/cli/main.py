...
app = typer.Typer(
    name="adhidebug",
    help="adhi-debugadhidebug — AI-powered threat detection engine",
...
DEFAULT_EXPERIMENT_NAME = "adhi-debugadhidebug-training"
...
def serve(
    ...
    """
    Start the adhi-debugadhidebug API server
    """
    import uvicorn
