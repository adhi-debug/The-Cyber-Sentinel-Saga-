...
Tests the adhidebugExperiment MLflow context manager for run
...
Connects to:
  ml/experiment - adhidebugExperiment
"""
...
from ml.experiment import adhidebugExperiment
...
class TestadhidebugExperiment:
    ...
    def test_run_id_is_none_before_enter(self) -> None:
        ...
        """
        exp = adhidebugExperiment("test-exp")
    ...
    def test_failed_status_on_exception(self) -> None:
        ...
        """
        run_id = None
        with pytest.raises(ValueError), adhidebugExperiment("test-exp") as exp:
            run_id = exp.run_id
