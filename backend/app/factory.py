...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    logger.info("adhi-debugadhidebug started — pipeline active")
    ...
    logger.info("adhi-debugadhidebug shut down cleanly")
...
def create_app() -> FastAPI:
    """
    Build and configure the adhi-debugadhidebug FastAPI application.
    """
    app = FastAPI(
